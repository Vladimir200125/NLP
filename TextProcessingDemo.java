//javac -cp "/home/share/4.142.2.23/apache-opennlp-2.5.0/lib/*" Charter2.java
//java -cp "/home/share/4.142.2.23/apache-opennlp-2.5.0/lib/*" Charter2.java
...
class Charter2{
        ...
        private static void usingTheOpenNLPLemmatizer() {
                try{
                        String[] tokens = new String[]{ "для", "раз", "на", "ноги"};
                        ...
                        InputStream dictLemmatizer = new FileInputStream("/home/share/4.142.2.23/Мишенин Владимир/en-lemmatizer.txt");
                        ...
                        for (int i = 0; i < tokens.length; i++) {
                                System.out.println(tokens[i] + " - " + tagsN[i] + " : " + lemmas[i]);
                        }
                }catch (Exception e) {
                        e.printStackTrace();
                }
